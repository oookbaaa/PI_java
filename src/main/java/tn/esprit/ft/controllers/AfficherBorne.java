...
public class AfficherBorne {
    ...
    private void openMap(float latitude, float longitude) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader((HelloApplication.class.getResource("/LocationView.fxml")));
    ...
    private void modifier(Bornes borne) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/ModifierBorne.fxml"));
    ...
    @FXML
    public void Afficher_intervention(javafx.scene.input.MouseEvent mouseEvent) throws IOException {
        Stage primaryStage = new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/AfficherIntervention.fxml"));
        Parent root = fxmlLoader.load();
        Scene scene = new Scene(root);
        primaryStage.setTitle("HELLO");
        primaryStage.setScene(scene);
    ...
    public void newinv(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/AjouterBorne.fxml"));
        Parent root = fxmlLoader.load();
